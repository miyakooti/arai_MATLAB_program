function [rawdata] = PolymateMini_SSSEP_8ch_exam(subject, condition, rectime)
% subject: 被験者名
% condition: 実験条件名
...
MEL_SAMPLE_LIST_CH = [
    ...
    MELCTRL_DEVTYPE_EXT+1 MELCTRL_DEVTYPE_EXT+2];   % チャンネルの設定 (自分用に変更する)
CH_NAME = {'FpZ' 'FC3' 'FCz' 'FC4' 'O1' 'O2' 'EX1' 'EX2'};
...
EEG_CH = 1:5;% "EEG = 脳電位(脳波)" ここ計測する脳波チャンネル数分に変更
% EOG_CH = 7:8;% "EOG = 眼電位" 瞬きの電位を記録する場合に使用?
